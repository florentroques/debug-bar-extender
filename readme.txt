=== Debug-Bar-Extender ===
Contributors: tott, florentroques, automattic
...
* replaced deprecated usage of function create_function` (deprecated since PHP 7.2.0) by an anonymous function, supported from PHP 5.3.0
* added Requires PHP: 5.3.0 field, required by anonymous functions usage
* tested up to 4.9.7
